...
class AddNewBarcode : ComponentActivity() {
    ...
    fun Greeting2(modifier: Modifier = Modifier) {
        ...
        Column(
            ...
            Row( modifier = modifier_element
                ...
                .clickable(onClick = { openBarCodeScanner(context) }) ,
                horizontalArrangement = Arrangement.Start,
                verticalAlignment = Alignment.CenterVertically){
                Icon(painter = painterResource(id = R.drawable.camera50), contentDescription = "",
                    tint  = Color(225,225,225), modifier = Modifier
                        .padding(12.dp)
                        .size(40.dp)
                )
                Text(text = text_open_scanner, fontWeight = FontWeight.Bold, fontSize = 25.sp,
                    color = Color(225,225,225),
                    modifier = Modifier.padding(start = 20.dp))
            }
            if(error_info.value != ""){
                OutlinedTextField(value = error_info.value, onValueChange = {},
                    enabled = false, modifier = modifier_element, colors = OutlinedTextFieldDefaults.colors(disabledTextColor = Color.Red, disabledBorderColor = Color.Red)
                )
            }
            ...
            Row(
                ...
                Text(
                    text = easily_Segreable_Text.value, modifier = Modifier
                        .padding(10.dp)
                        .padding(start = 40.dp), color = color_easily_segreable_switch.value
                )
            }
            Row(
                modifier = modifier_element
                ...
                Text(
                    text = required_washing.value, modifier = Modifier
                        .padding(10.dp)
                        .padding(start = 40.dp), color = color_required_washing_switch.value
                )
            }
            Column(
                verticalArrangement = Arrangement.Top,
                    ...
                    Row(
                        ...
                        Icon(imageVector = Icons.Default.Delete, contentDescription = "",
                            tint = Color.Blue, modifier = Modifier
                                ...
                                .combinedClickable(
                                    onClick = {
                                        text_where_to_throw_statement.value = value_to_be_assigned_5
                        ...
                        Icon(imageVector = Icons.Default.Delete, contentDescription = "",
                            tint = Color.Yellow, modifier = Modifier
                                .size(50.dp)
                                .combinedClickable(
                                    onClick = {
                                        text_where_to_throw_statement.value = value_to_be_assigned_6
                        ...
                        Icon(imageVector = Icons.Default.Delete, contentDescription = "",
                            tint = Color.Green, modifier = Modifier
                                ...
                                .combinedClickable(
                                    onClick = {
                                        text_where_to_throw_statement.value = value_to_be_assigned_7
                        ...
                        Icon(imageVector = Icons.Default.Delete, contentDescription = "",
                            tint = Color.Black, modifier = Modifier
                                ...
                                .combinedClickable(
                                    onClick = {
                                        text_where_to_throw_statement.value = value_to_be_assigned_8
                        ...
                        Icon(imageVector = Icons.Default.Delete, contentDescription = "",
                            tint = Color.Red, modifier = Modifier
                                ...
                                .combinedClickable(
                                    onClick = {
                                        text_where_to_throw_statement.value = value_to_be_assigned_9
    ...
    private fun openBarCodeScanner(context: Context){
